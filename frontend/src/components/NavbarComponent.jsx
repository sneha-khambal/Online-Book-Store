...
export function StickyNavbar({title}) {
 ...
 useEffect(() => {
  ...
  const navList = (
    <ul className={` mb-4 flex  ${hideNav ? 'flex-col':'flex-row'} gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 `}>
      <Typography
        as="li"
        variant="small"
        color="blue-gray"
  ...
  const sectionList = (
     <ul className={` lg:mr-50 md:mr-0 mb-4 flex  ${hideNav ? 'flex-col':'flex-row'} gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 `}>
                      <li>
                        {" "}
                        <DropdownComponent
                          title={"HOME"}
  ...
  return (
    <div className="  w-[calc(100%+48px)] overflow-hidden px-5 lg:px-20">
      <Navbar className={`sticky top-0 z-10 h-max max-w-full rounded-none  bg-white text-black mt-4 `}>
        ...
        >
          ...
          <div className="flex items-center gap-5 ">
            ...
            : 
           <div className="mr-4 flex">{sectionList}
           {title != 'headerNavbar' ? <div className="flex items-center  lg:mr-[5rem]">  <FaShoppingCart size={50} />  </div> :''}
           </div>
                    }
