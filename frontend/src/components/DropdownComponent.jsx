...
export const DropdownComponent = ({title,data}) => {
  ...
  return (
     <span className='group w-50 mr-5'>{currencyType}
      ...
      <ul id="CurrencyType" className="absolute w-35 mt-3 bg-white border-solid-gray rounded shadow-lg opacity-0  group-hover:opacity-100 group-hover:visible transition-opacity duration-200 z-10">
